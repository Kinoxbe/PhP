...
//DISPLAY
    ...
    function displayLoginPage($building_list) {
        $this->templatelogin($building_list);
        return $this->render;
    }
...
// TEMPLATE
    ...
    function templatelogin($building_list) {
        $this->page = $this->generateHeader();
        $this->page .= $this->generateLoginPage($building_list);
        $this->page .= $this->generateFooter();
        $this->render = $this->generateShell();
    }
...
// GENERATE
    ...
    function generateLoginPage($building_list) {
        ob_start();
            include "views/templates/login_view.php";
            return ob_get_clean();
    }
