...
$(document).ready(function () {
    ...
    //Chargement dynamique de la page mais fait bug le jsquery
    ...
    //     console.log('test');
    //     event.preventDefault();
    //     $.get('Views/ajax.php' , {pk:$('#pk-search').val()}
    //     )
    //         .done(function(data) {
    //             $('#ajax-rsp').html(data);
    //         })
